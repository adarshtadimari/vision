...
int main(int argc,char *argv[])
{
    ...
    mask=cvCreateImage(cvSize(640,480),8,1);
    IplImage* framet=cvCreateImage(cvSize(640,480),8,1);
    IplImage* frame;
    char c=0;
    ...
    while(c!='q')
    {
        ...
        cvCvtColor(frame,framet,CV_BGR2GRAY);
        //cvShowImage("Vid",framet);
        cvThreshold(framet,framet,255,1,CV_THRESH_BINARY);
        //cvThreshold(framet,framet,255,5,CV_THRESH_BINARY_INV);
        cvShowImage("Vide",framet);
        c=cvWaitKey(33);
