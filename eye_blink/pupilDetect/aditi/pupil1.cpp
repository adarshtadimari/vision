...
int main(int argc,char* argv[])
{
	...
	*/   
    ...
    //Computing dot product of gradient and position vector
	for(int j1=0;j1<src.rows;j1++)
		for(int i1=0;i1<src.cols;i1++)
		{
		  if(srcInv.at<uchar>(j1,i1)&& abs(i1-mid)<range)  //Only valid points taken
		  	{
				float dot=0;
