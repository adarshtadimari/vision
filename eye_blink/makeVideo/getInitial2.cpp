...
string nestedCascadeName = "haarcascade_righteye_2splits.xml";

Mat xDerivative,xNorm,finalCropped;
char c=0;
int initialPoints()
{
    CvCapture* capture = 0;
...
/*    for( int i = 1; i < argc; i++ )
    ...
    cascadeName="";
        ...
        nestedCascadeName = "haarcascade_righteye_2splits.xml";
    ...
    for( vector<Rect>::const_iterator r = faces.begin(); r != faces.end(); r++, i++ )
    {
        ...
        for( vector<Rect>::const_iterator nr = nestedObjects.begin(); nr != nestedObjects.end(); nr++ )
        {
            ...
            if(center.x < faceCenter.x )
            {
                ...
                if(c=='s')
                {
                   initialPoint[0]=Point(center.x-radius,center.y-radius);
                   initialPoint[1]=Point(center.x+radius,center.y+radius);
                   cout<<initialPoint[0]<<initialPoint[1];
                }
